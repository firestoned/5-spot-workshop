...
if [ "$fail" = 0 ]; then
  echo "✓ Published. URLs:"
  echo "    https://labs.iximiuz.com/skill-paths/5-spot-ctf"
  echo "    https://labs.iximiuz.com/challenges/5spot-ctf-capd"
  echo "    https://labs.iximiuz.com/challenges/5spot-ctf-k0smotron"
else
